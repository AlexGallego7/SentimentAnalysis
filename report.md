...
### Code Quality (`code-quality`) — **72.7**%
...
❌ | 81.7% | 1 | Pylint reports no issues with this project | `code-quality/pylint/no-issues`
...
❌ | 0.0% | 1 | Bandit reports no issues with this project | `code-quality/bandit/no-issues`
 | _Total_ | | | 
❌ | **72.7**% | | Code Quality | `code-quality`
...
Pylint reported **4** issues with your project:

- `src/model.py:45,28` - _(W0108)_ Lambda may not be necessary
- `src/model.py:75,24` - _(W0108)_ Lambda may not be necessary
